...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		distence=math.sqrt(((finger_tip_x-thumb_tip_x)**2)+((finger_tip_y-thumb_tip_y)**2))

		print("computerscreensize:",screen_width,screen_height,"outputwindowsize:",width,height)
		...
		mouse.positiion=(relative_mouse_x,relative_mouse_y)
